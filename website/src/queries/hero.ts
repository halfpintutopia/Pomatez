  ...
  useStaticQuery<HeroQueryProps>(graphql`
    {
      ...
      workTimePreviewLight: file(
        relativePath: { eq: "work-time-light.PNG" }
      ) {
        childImageSharp {
      ...
      workTimePreviewDark: file(
        relativePath: { eq: "work-time-dark.PNG" }
      ) {
        childImageSharp {
          fluid(maxWidth: 250, quality: 90) {
            ...GatsbyImageSharpFluid_withWebp
      ...
      configPreviewLight: file(
        relativePath: { eq: "config-light.PNG" }
      ) {
        childImageSharp {
          fluid(maxWidth: 250, quality: 90) {
            ...GatsbyImageSharpFluid_withWebp
      ...
      settingsPreviewLight: file(
        relativePath: { eq: "settings-light.PNG" }
      ) {
        childImageSharp {
          fluid(maxWidth: 220, quality: 90) {
            ...GatsbyImageSharpFluid_withWebp
      ...
      settingsPreviewDark: file(
        relativePath: { eq: "settings-dark.PNG" }
      ) {
        childImageSharp {
          fluid(maxWidth: 220, quality: 90) {
            ...GatsbyImageSharpFluid_withWebp
